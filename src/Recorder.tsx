...
export default function Recorder({ onNewDownloadUrl }: RecorderProps) {
  ...
  const toggleRecording = useCallback(
    ...
    [recorder, microphoneAccess, onNewDownloadUrl]
  );
  ...
  const requestMicrophoneAccess = useCallback(
    ...
    [recorder, deinitializeMicrophoneStream]
  );
  ...
  useEffect(
    ...
    [recorder, deinitializeScreenStream, deinitializeCameraStream, deinitializeMicrophoneStream]
  );
